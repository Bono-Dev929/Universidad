...
public class Supermercado {
	...
	public boolean agregarItem(long dni, int idP, int c, int idC) throws Exception {
		
		if (traerCliente(dni) == null || traerProducto(idP) == null || traerCarritos(dni).get(idC) == null) 
			throw new Exception("Cliente, IDProducto o IdCarrito Erroneos");
